...
""" 1. Load dataset """
# root_dir = os.path.join('/', 'Users', 'sangwonhwang', 'Desktop', 'AlexNet', 'asirra')    # FIXME
# root_dir = os.path.join('/', 'Users', 'sangwonhwang', 'Desktop', 'mikecohen_퓨리에변환', 'data', 'real')    # FIXME
# root_dir = os.path.join('/', 'Users', 'sangwonhwang', 'Desktop', 'mikecohen_퓨리에변환', 'data', 'magnitude05', 'amor')    # FIXME
# root_dir = os.path.join('/', 'Users', 'sangwonhwang', 'Desktop', 'mikecohen_퓨리에변환', 'data', 'magnitude', 'click')    # FIXME
root_dir = os.path.join('/', 'Users', 'sangwonhwang', 'Desktop', 'mikecohen_퓨리에변환', 'data', 'angle05', 'bump')    # FIXME
